...
EXAMPLE_CONF_FILE=${EXAMPLE_CONF_FILE:-$SHARE_EXAMPLES_DIR/peercoin.conf}
...
then
  ...
  echo -e "To safely generate a peercoin.conf file, please commit your changes to $BITCOIND, rebuild, then run this script again.\n"
fi

echo 'Generating example peercoin.conf file in share/examples/'
...
##
## peercoin.conf configuration file.
## Generated by contrib/devtools/gen-peercoin-conf.sh.
##
...
# parse the output from peercoind --help
