...
bech32_templates = [
  ...
  ('pc',    0, 20, (False, 'main',    None, True), p2wpkh_prefix),
  ('pc',    0, 32, (False, 'main',    None, True), p2wsh_prefix),
  ('pc',    1,  2, (False, 'main',    None, True), (OP_1, 2)),
  ('tpc',   0, 20, (False, 'test',    None, True), p2wpkh_prefix),
  ('tpc',   0, 32, (False, 'test',    None, True), p2wsh_prefix),
  ('tpc',   2, 16, (False, 'test',    None, True), (OP_2, 16)),
  ('pcrt',  0, 20, (False, 'regtest', None, True), p2wpkh_prefix),
  ('pcrt',  0, 32, (False, 'regtest', None, True), p2wsh_prefix),
  ('pcrt', 16, 40, (False, 'regtest', None, True), (OP_16, 40))
]
