...
std::string HelpMessage()
{
    ...
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: ppcoind.pid)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. PPCoin is probably already running."), strDataDir.c_str()));
