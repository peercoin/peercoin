...
CMutableTransaction::CMutableTransaction() : nVersion(gArgs.GetArg("-txversion", CTransaction::CURRENT_VERSION)), nTime(GetAdjustedTime()), nLockTime(0) {}
...
CTransaction::CTransaction() : vin(), vout(), nVersion(gArgs.GetArg("-txversion", CTransaction::CURRENT_VERSION)), nTime(GetAdjustedTime()), nLockTime(0), hash{}, m_witness_hash{} {}
