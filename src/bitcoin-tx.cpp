...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = strprintf("%s peercoin-tx utility version", PACKAGE_NAME) + " " + FormatFullVersion() + "\n\n" +
            "Usage:\n"
              "  peercoin-tx [options] <hex-tx> [commands]  Update hex-encoded peercoin transaction\n" +
              "  peercoin-tx [options] -create [commands]   Create hex-encoded peercoin transaction\n" +
              "\n";
