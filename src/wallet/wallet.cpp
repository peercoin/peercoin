...
void CWallet::AvailableCoins(std::vector<COutput>& vCoins, const CCoinControl* coinControl, const uint32_t nSpendTime, const CAmount& nMinimumAmount, const CAmount& nMaximumAmount, const CAmount& nMinimumSumAmount, const uint64_t nMaximumCount) const
{
    AssertLockHeld(cs_wallet);
        ...
        bool sign)
{
    ...
    int nBytes;
    {
        ...
        txNew.nLockTime = GetLocktimeForNewTransaction(chain(), GetLastBlockHash(), GetLastBlockHeight());
        {
            ...
            AvailableCoins(vAvailableCoins, &coin_control, txNew.nTime, 1, MAX_MONEY, MAX_MONEY, 0);
