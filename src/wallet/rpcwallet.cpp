...
static UniValue listunspent(const JSONRPCRequest& request)
{
    RPCHelpMan{
                ...
                "Optionally filter to only include txouts paid to specified addresses.\n",
                {
                    ...
                    {"addresses", RPCArg::Type::ARR, /* default */ "empty array", "The peercoin addresses to filter",
                        {
    ...
    std::vector<COutput> vecOutputs;
    {
        ...
        LOCK(pwallet->cs_wallet);
        pwallet->AvailableCoins(vecOutputs, !include_unsafe, &cctl, 0, nMinimumAmount, nMaximumAmount, nMinimumSumAmount, nMaximumCount);
    }
...
UniValue walletcreatefundedpsbt(const JSONRPCRequest& request)
{
    ...
    FundTransaction(pwallet, rawTx, fee, change_position, request.params[4], coin_control);
