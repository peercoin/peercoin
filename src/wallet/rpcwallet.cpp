...
UniValue getlabeladdress(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() != 1)
        throw std::runtime_error(
            ...
            "\nReturns the current Peercoin address for receiving payments to this label.\n"
            "\nArguments:\n"
            ...
            "\nResult:\n"
            "\"address\"          (string) The label peercoin address\n"
            "\nExamples:\n"
...
UniValue setlabel(const JSONRPCRequest& request)
{
    ...
    if (request.fHelp || request.params.size() < 1 || request.params.size() > 2)
        throw std::runtime_error(
            ...
            "\nArguments:\n"
            "1. \"address\"         (string, required) The peercoin address to be associated with a label.\n"
