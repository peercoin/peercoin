...
CoinSelectionParams coin_selection_params(false, 0, 0, 0, false);
...
BOOST_AUTO_TEST_CASE(bnb_search_test)
{
    ...
    CoinSelectionParams coin_selection_params_bnb(true, 0, 0, 0, false);
    CoinSet setCoinsRet;
    CAmount nValueRet;
    bool bnb_used;
    empty_wallet();
...
BOOST_AUTO_TEST_CASE(SelectCoins_test)
{
    ...
    for (int i = 0; i < 100; ++i)
    {
        ...
        // Perform selection
        CoinSelectionParams coin_selection_params_knapsack(false, 34, 148, 0, false);
        CoinSelectionParams coin_selection_params_bnb(true, 34, 148, 0, false);
        CoinSet out_set;
        CAmount out_value = 0;
        bool bnb_used = false;
