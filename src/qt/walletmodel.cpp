...
void WalletModel::checkBalanceChanged(const interface::WalletBalances& new_balances)
{
    if(new_balances.balanceChanged(m_cached_balances)) {
        ...
        Q_EMIT balanceChanged(new_balances.balance, new_balances.stake, new_balances.unconfirmed_balance, new_balances.immature_balance, new_balances.watch_only_balance, new_balances.unconfirmed_watch_only_balance, new_balances.immature_watch_only_balance);
    }
}
