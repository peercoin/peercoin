...
void BitcoinGUI::createActions()
{
    ...
    connect(mintingAction, &QAction::triggered, this, static_cast<void (BitcoinGUI::*)()>(&BitcoinGUI::showNormalIfMinimized));
    connect(mintingAction, &QAction::triggered, this, &BitcoinGUI::gotoMintingPage);
    connect(multisigAction, &QAction::triggered, this, static_cast<void (BitcoinGUI::*)()>(&BitcoinGUI::showNormalIfMinimized));
