...
void OptionsDialog::setMapper()
{
    ...
    mapper->addMapping(ui->backgroundImage, OptionsModel::BackgroundImage);
}
...
void OptionsDialog::showRestartWarning_Proxy()
{
    ...
    {
        QMessageBox::warning(this, tr("Warning"), tr("This setting will take effect after restarting Sprouts."), QMessageBox::Ok);
