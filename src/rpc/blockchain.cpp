...
static UniValue getdifficulty(const JSONRPCRequest& request)
{
    ...
    obj.pushKV("proof-of-stake",       GetDifficulty(GetLastBlockIndex(EnsureAnyChainman(request.context).ActiveChain().Tip(), true)));
        ...
        },
        {
            ...
            RPCResult{"Otherwise", RPCResult::Type::OBJ, "", "", {
                ...
                {RPCResult::Type::OBJ, "scriptPubKey", "", {
                    ...
                    {RPCResult::Type::STR, "address", /* optional */ true, "peercoin address (only if a well-defined address exists)"},
                    {RPCResult::Type::ARR, "addresses", /* optional */ true, "(DEPRECATED, returned only if config option -deprecatedrpc=addresses is passed) Array of peercoin addresses",
