...
#define BUILD_DESC BUILD_DESC_WITH_SUFFIX(PEERCOIN_VERSION_MAJOR, PEERCOIN_VERSION_MINOR, PEERCOIN_VERSION_REVISION, PEERCOIN_VERSION_BUILD, BUILD_GIT_COMMIT)
