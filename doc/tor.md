...
It is possible to run Peercoin as a Tor onion service, and connect to such services.
...
## 2. Manually create a Peercoin onion service
...
Peercoin automatically creates a onion service to listen on. This will positively
...
- Do not add anything but peercoin ports to the onion service created in section 2.
