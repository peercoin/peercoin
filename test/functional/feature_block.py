...
class FullBlockTest(ComparisonTestFramework):
    ...
    def get_tests(self):
        ...
        #                      \-> b3 (1) -> b4 (2)
        self.move_tip(6)
        self.next_block(9, spend=out[4], additional_coinbase_value=10000000000)
        ...
        self.next_block(11, spend=out[4], additional_coinbase_value=10000000000)
        yield self.rejected(RejectResult(16, b'bad-cb-amount'))
        ...
        self.next_block(14, spend=out[5], additional_coinbase_value=10000000000)
        yield self.rejected()
